...
# GML Explorer
RUN cd && mkdir -p /home/abm/ && git clone https://27ee2a564cd83c96a19a3f2f49fc3ecbbc599e98:x-oauth-basic@github.com/cb-cities/gml-explorer.git && cd gml-explorer && cabal update && make
